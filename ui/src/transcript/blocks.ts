...
export type Block =
  ...
  | { kind: 'text'; id: string; text: string; streaming: boolean; at?: string }
  ...
  | { kind: 'thinking'; id: string; text: string; streaming: boolean; at?: string }
  | { kind: 'tool'; id: string; name: string; input: Record<string, unknown>; summary: string; result?: ToolResult; streaming: boolean; at?: string }
